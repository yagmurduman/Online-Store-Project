...
<template>
  ...
  <div class="container">
    ...
    <img  class="container rounded" style=" box-shadow: 0 0 10px rgb(124, 85, 75);" src="../assets/books.png" alt="" />
...
export default {
  ...
  computed:{
    ...
    groupedProducts() {
      return _.chunk(this.products, 8)
    },
    ...mapGetters([
      'cid','isLoggedIn'])
  },
  ...
  methods:{
    ...
    loadmore() {
       ...
       if(this.filtered==0){
         console.log("no")
          axios.post("http://localhost:8090/product/get-by-type/?key="+this.len +"&type=book" )
          .then(response => {
    ...
    filter(){ 
     axios.post(
       //ilk key 0
      "http://localhost:8090/filter/extended-filter?category="+this.category+"&key=0&orderType="+this.order+"&price="+this.price+"&rate="+this.rate+"&type=book")    
    ...
    filterrest(){
       axios.post(
       //ilk key 0
      "http://localhost:8090/filter/extended-filter?category="+this.category+"&key="+this.len+"+&orderType="+this.order+"&price="+this.price+"&rate="+this.rate+"&type=book")    
     .then(response => {
            {if(response.status==200)
  ...
  mounted() {
    axios
      .post("http://localhost:8090/product/get-by-type/?key=0&type=book")
