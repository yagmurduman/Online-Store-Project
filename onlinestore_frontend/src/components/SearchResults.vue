<template>
  <div class="container">
  <h4 class="font-weight-bold text-center dark-grey-text " style="margin-bottom:70px;margin-top:40px">Search Results for {{this.searchkey}}</h4>
  ...
  <section  style="box-shadow: 0 0 10px rgb(124, 85, 75);" class="row-fluid">
      ...
      <div class="col-lg-2 border mx-auto">
          ...
          <h5 class="font-weight-bold mb-3">Category</h5>
            ...
            <div class="divider-small mb-2"></div>
              <input type="radio"  v-model="category" value="all" class="form-check-input" id="materialGroupExample2" name="groupOfMaterialRadios2">
              <label class="form-check-label" for="materialGroupExample1">All</label>
              <div class="divider-small mb-2"></div>
              <input type="radio"  v-model="category" value="book" class="form-check-input" id="materialGroupExample2" name="groupOfMaterialRadios2">
              <label class="form-check-label" for="materialGroupExample1">Book</label>
              <div class="divider-small mb-2"></div>
              <input type="radio"  v-model="category" value="music" class="form-check-input" id="materialGroupExample2" name="groupOfMaterialRadios2">
              <label class="form-check-label" for="materialGroupExample1">Music</label>
              <div class="divider-small mb-2"></div>
              <input type="radio"  v-model="category" value="dvd" class="form-check-input" id="materialGroupExample2" name="groupOfMaterialRadios2">
              <label class="form-check-label" for="materialGroupExample1">DVD</label>
              <div class="divider-small mb-4"></div>
...
export default {
  ...
  methods:{
    ...
    filter(){ 
     axios.post(
    "http://localhost:8090/filter/search-extended-filter?category=0&key=0&orderType="+this.order+"&price="+this.price+"&rate="+this.rate+"&search="+this.searchkey+"&type="+this.category)
       
     .then(response => this.$store.commit('setproducts',response.data),console.log(this.searchProduct))
    ...
    filterrest(){
       axios.post(
       //ilk key 0
     "http://localhost:8090/filter/search-extended-filter?category=0&key="+this.len+"&orderType="+this.order+"&price="+this.price+"&rate="+this.rate+"&search="+this.searchkey+"&type="+this.category)
       .then(response => {
    ...
    loadmore() {
       if(this.filtered==0)
       {
          ...
          axios.post("http://localhost:8090/search/search-limit?key="+this.len +"&search="+this.searchkey )
          .then(response => {
            {if(response.status==200)
